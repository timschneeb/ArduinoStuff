#if ENABLE_SCREEN
void CheckKeyboardHitbox(int x, int y) {
...
/*
  ...
  myGLCD.setColor(WHITE);
  myGLCD.setBackColor(BLACK);
  myGLCD.print("Saving SSID", 20, 50);
  myGLCD.print("to the EEPROM...", 20, 70);
  ClearRangeEEPROM(6, 38);

  String completeSSID = selectedSSID + ">";
  StoreStringEEPROM(completeSSID.c_str(), 6);

  myGLCD.print("Saving Password", 20, 50);
  myGLCD.print("to the EEPROM...", 20, 70);

  String completePwd = input + ">";
  Serial.println(completePwd);
  ClearRangeEEPROM(39, 64);
  StoreStringEEPROM(completePwd.c_str(), 39);
